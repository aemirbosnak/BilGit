...
public class SettingsFragment extends Fragment {
    /**
     * Kodun en aşağısında kullandığım kodların orijinal hali var,
     * bir takım değişiklikler yaparak bu class'ın eski haline implement ettim
     *
     * Anlamadığım yerlerin/errorların yanına ekstra notlar koydum
     * faydalandığım sitenin linki: https://www.geeksforgeeks.org/android-how-to-upload-an-image-on-firebase-storage/
     */
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //I wrote the remaining of onCreate() method, it may have bugs
        ...
        ActionBar actionBar;
        actionBar = getSupportActionBar(); //what is that?
        ...
        // initialise views
        btnSelect = btnSelect.findViewById(); //which numbers should we use?
        btnUpload = btnUpload.findViewById();
    ...
    /**
     * Bu method SettingsFragment'ta da olduğu için deprecate ediliyor
     */
    /*
